...
# Takes in a model file created by mrkfeed.awk and generates a string of 
# n words by picking sequential words based on how frequently they follow
# the previous word in the model file.
